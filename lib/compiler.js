...
function getGetterSymbol(state, cls, name, instanceName, symbolname, node, nodefail) {
	...
	return {type:'statement',metatype:'getter',symbolname:symbolname,instance:instanceName,class:cls,name:name,location:node.start,argcount:1,property:property,returnType:property.returnType};
}
