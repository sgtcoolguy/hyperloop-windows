...
function packageApp(options, solutionFile, callback) {
	var configuration = buildlib.getMSBuildConfiguration(options),
		vsargs = ' '+buildlib.getMSBuildTarget(options,options.name+'\\'+options.name)+' /p:Configuration='+configuration;
